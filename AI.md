...
* **技能与工具管理**：管理 AI 可以调用的外部工具（如向量检索、图数据库查询）。这确保了 AI 的回答不仅基于训练数据，还能基于 **iBizPLM 实时数据**。
...
* **文本处理-写作**：对工作项的描述内容进行润色、纠错和专业化表达，提升文档质量。
...
* **知识文档自动摘要/打标**：对长篇 Wiki 文档生成 300字核心摘要，并自动识别关键词、文档类型，填充元数据，提升知识库检索效率。
* **专家问答**：基于企业私有知识库和代码库，提供快速、精准的专业技术问答服务。
