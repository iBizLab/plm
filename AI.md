...
在软件研发的生命周期中，追求极致的效率和信息质量是永恒的目标。iBizPLM AI+ 版本正式上线！引入了全新的 智能体管理中心，并创造了 六类精通软件工程方法论 的核心智能体，将 AI 的能力全面释放到 需求、开发、测试、协作 的每一个环节。
...
* **技能与工具管理**：管理 AI 可以调用的外部工具（如MCP,向量检索、数据库查询）。这确保了 AI 的回答不仅基于训练数据，还能基于 **iBizPLM 实时数据**。
...
### ⚡️ 核心亮点三：六类「智能体」落地，加速核心工作流

我们的六类智能体深入集成到您的工作流中，以结构化的数据输出，驱动 iBizPLM 的自动化。
