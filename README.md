...
> 🚀 iBizPLM AI+ 重磅上线｜六类智能体全面赋能iBizPLM工作流！ 全新的企业级研发副驾驶，现已集成到 iBizPLM：
> 
> * **🧠 智能体管理中心**：可控、安全、多模型接入
> * **👁️ 多模态理解能力**：截图、流程图、架构图统统可读
> * **⚙️ 深度嵌入研发流程**：需求、开发、测试、运营全链路覆盖
> * **🔍 六类工程智能体**：需求拆解、测试生成、缺陷分析、工作项治理等全面智能化
> 
> 让您的团队实现 更快需求澄清、更准测试生成、更强质量保障、更高协作效率。
> 
> 开启 AI 驱动的软件工程新时代！[详见>>](AI.md)
...
| 33   | 2025-12-07    | V1.0.20251207      | 新增：AI辅助功能；优化：工时登记、各编辑器插件等   |
