...
### 关联界面行为
  ...
  * [项目(PROJECT)](module/ProjMgmt/project) : [复制项目](module/ProjMgmt/project#界面行为)
  * [基线(BASELINE)](module/Base/baseline) : [编辑](module/Base/baseline#界面行为)
  ...
  * [迭代(SPRINT)](module/ProjMgmt/sprint) : [编辑](module/ProjMgmt/sprint#界面行为)
  * [文件夹(PORTFOLIO)](module/Base/portfolio) : [编辑基本信息](module/Base/portfolio#界面行为)
  ...
  * [空间(SPACE)](module/Wiki/space) : [标记主知识库](module/Wiki/space#界面行为)
...
### 关联视图
  ...
  * [复制项目(project_copy_wizard_view)](app/view/project_copy_wizard_view)
