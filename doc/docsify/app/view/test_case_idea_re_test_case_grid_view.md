# 用例(test_case_idea_re_test_case_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面逻辑
  * [用例(TEST_CASE)](module/TestMgmt/test_case) : [需求关联用例](module/TestMgmt/test_case/uilogic/idea_relation_test_case)
