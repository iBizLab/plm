# kanban工作项(work_item_dyna_kanban_main_view)  <!-- {docsify-ignore-all} -->
...
if (form) {
    ...
    const tabpanel1_child = form.details.tabpanel1_child;
    const counter = tabpanel1_child.counter;
    counter.onChange(() => {
        const _type = form.state.data.work_item_sub_type;
        tabpanel1_child.state.visible = !!_type;
    })
}
```
