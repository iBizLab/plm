# 需求(idea_main_view_pop_up)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  ...
  * [需求(IDEA)](module/ProdMgmt/idea) : [建立版本](module/ProdMgmt/idea#界面行为)
  ...
  * [需求(IDEA)](module/ProdMgmt/idea) : [移动（工具栏）](module/ProdMgmt/idea#界面行为)
