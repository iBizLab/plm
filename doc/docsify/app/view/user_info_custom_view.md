...
### 关联界面行为
  ...
  * [企业用户(USER)](module/Base/user) : [打开关于界面](module/Base/user#界面行为)
  * [页面(PAGE)](module/Wiki/article_page) : [打开更新日志](module/Wiki/article_page#界面行为)
  * [关于(ABOUT)](module/extension/ABOUT) : [关于](module/extension/ABOUT#界面行为)

### 关联视图
  * [关于(about_system_about)](app/view/about_system_about)
