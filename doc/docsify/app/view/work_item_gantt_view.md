...
### 关联界面行为
  ...
  * [工作项(WORK_ITEM)](module/ProjMgmt/work_item) : [新建动态工作项（all）](module/ProjMgmt/work_item#界面行为)
...
### 关联视图
  ...
  * [工作项(work_item_dyna_quick_create_view)](app/view/work_item_dyna_quick_create_view)
