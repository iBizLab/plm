# 工作项(work_item_baseline_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [工作项(WORK_ITEM)](module/ProjMgmt/work_item) : [基线规划工作项](module/ProjMgmt/work_item#界面行为)
  * [工作项(WORK_ITEM)](module/ProjMgmt/work_item) : [移出基线](module/ProjMgmt/work_item#界面行为)
