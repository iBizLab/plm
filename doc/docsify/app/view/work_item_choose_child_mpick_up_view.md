# 选择工作项(work_item_choose_child_mpick_up_view)  <!-- {docsify-ignore-all} -->
...
### 关联视图
  * [工作项(work_item_choose_child_mpick_up_grid_view)](app/view/work_item_choose_child_mpick_up_grid_view)
