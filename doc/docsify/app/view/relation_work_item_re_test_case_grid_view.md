# 关联(relation_work_item_re_test_case_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面逻辑
  * [用例(TEST_CASE)](module/TestMgmt/test_case) : [工作项关联用例值变更](module/TestMgmt/test_case/uilogic/work_item_relation_test_case)
