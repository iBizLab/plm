# 关联(relation_work_item_re_idea_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面逻辑
  * [需求(IDEA)](module/ProdMgmt/idea) : [工作项关联需求值变更](module/ProdMgmt/idea/uilogic/work_item_relation_idea)
