...
<el-row>
  <el-menu :ellipsis="false" class="el-menu-demo" mode="horizontal" @select="handleSelect">
    ...
    <el-menu-item index="menuslot2" disabled>null</el-menu-item>
...
|  --------   |------------| -----------|  -----   |  -----   |
|[设计](app/view/PSDELogicLogicDesign_AIAgent)|PSDELogicLogicDesign_AIAgent|实体处理逻辑|实体子应用引用视图||
...
|[绑定智能体](app/view/ai_agent_assignment_bind)|ai_agent_assignment_bind|绑定智能体|实体编辑视图||
|[智能体选择器](app/view/ai_agent_assignment_selector)|ai_agent_assignment_selector|智能体选择器|实体列表视图||
|[智能体业务上下文编辑视图](app/view/ai_agent_context_edit_view)|ai_agent_context_edit_view|智能体|实体编辑视图||
...
|[智能体业务上下文表格视图](app/view/ai_agent_context_grid_view)|ai_agent_context_grid_view|智能体|实体表格视图||
|[智能体](app/view/ai_agent_context_info_view)|ai_agent_context_info_view|智能体|实体编辑视图||
|[智能体上下文](app/view/ai_agent_context_main_view)|ai_agent_context_main_view|智能体上下文|实体编辑视图||
|[我的智能体业务上下文表格视图](app/view/ai_agent_context_my_view)|ai_agent_context_my_view|我的智能体|实体表格视图||
|[智能体业务上下文](app/view/ai_agent_context_quick_create_view)|ai_agent_context_quick_create_view|智能体|实体编辑视图||
|[智能体会话编辑视图](app/view/ai_agent_conversation_edit_view)|ai_agent_conversation_edit_view|智能体会话|实体编辑视图||
|[智能体会话表格视图](app/view/ai_agent_conversation_grid_view)|ai_agent_conversation_grid_view|智能体会话|实体表格视图||
|[智能体编辑视图](app/view/ai_agent_edit_view)|ai_agent_edit_view|智能体模板|实体编辑视图|系统自动添加|
|[智能体表格视图](app/view/ai_agent_grid_view)|ai_agent_grid_view|智能体模板|实体表格视图||
...
|[智能体](app/view/ai_agent_quick_create_view)|ai_agent_quick_create_view|智能体模板|实体选项操作视图||
|[调试](app/view/ai_agent_session_debug_view)|ai_agent_session_debug_view|调试|实体编辑视图||
...
|[AI凭证编辑视图](app/view/ai_credential_edit_view)|ai_credential_edit_view|AI凭证|实体编辑视图||
|[AI凭证表格视图](app/view/ai_credential_grid_view)|ai_credential_grid_view|AI凭证|实体表格视图||
...
|[文档分块信息](app/view/ai_kb_chunk_chunk_info_view)|ai_kb_chunk_chunk_info_view|切片|实体编辑视图||
...
|[知识库文档分块](app/view/ai_kb_chunk_quick_create_view)|ai_kb_chunk_quick_create_view|知识库文档分块|实体选项操作视图||
|[检索测试](app/view/ai_kb_chunk_retrieval_test_custom_view)|ai_kb_chunk_retrieval_test_custom_view|检索测试|实体自定义视图||
|[文档分块](app/view/ai_kb_chunk_tree_grid_view)|ai_kb_chunk_tree_grid_view|知识库文档分块|实体树表格视图||
|[知识库文档信息视图](app/view/ai_kb_document_base_info_view)|ai_kb_document_base_info_view|文档信息|实体编辑视图||
|[知识库文档切片视图](app/view/ai_kb_document_chunk_view)|ai_kb_document_chunk_view|切片|实体编辑视图||
|[知识库文档编辑视图](app/view/ai_kb_document_edit_view)|ai_kb_document_edit_view|知识库文档|实体编辑视图|系统自动添加|
|[知识库文档表格视图](app/view/ai_kb_document_grid_view)|ai_kb_document_grid_view|知识库文档|实体表格视图||
|[文档元数据](app/view/ai_kb_document_meta_data_view)|ai_kb_document_meta_data_view|文档元数据|实体选项操作视图||
...
|[知识图谱](app/view/ai_kb_graph_entity_custom_view)|ai_kb_graph_entity_custom_view|知识图谱|实体多数据自定义视图||
|[知识库图谱实体编辑视图](app/view/ai_kb_graph_entity_edit_view)|ai_kb_graph_entity_edit_view|知识库图谱实体|实体编辑视图|系统自动添加|
|[知识库图谱实体类型](app/view/ai_kb_graph_entity_type_config_grid_view)|ai_kb_graph_entity_type_config_grid_view|知识库图谱实体类型|实体表格视图||
|[知识库图谱实体类型编辑视图](app/view/ai_kb_graph_entity_type_edit_view)|ai_kb_graph_entity_type_edit_view|知识库图谱实体类型|实体编辑视图|系统自动添加|
|[知识库图谱实体类型选项操作视图](app/view/ai_kb_graph_entity_type_quick_cfg_view)|ai_kb_graph_entity_type_quick_cfg_view|知识库图谱实体类型|实体选项操作视图||
|[知识库图谱实体选项操作视图](app/view/ai_kb_graph_entity_type_quick_create_view)|ai_kb_graph_entity_type_quick_create_view|新建知识库图谱实体类型|实体选项操作视图||
|[知识库图谱关系编辑视图](app/view/ai_kb_graph_relation_edit_view)|ai_kb_graph_relation_edit_view|知识库图谱关系|实体编辑视图|系统自动添加|
|[知识库成员](app/view/ai_kb_member_assigned_grid_view)|ai_kb_member_assigned_grid_view|知识库成员|实体表格视图||
...
|[设置角色](app/view/ai_kb_member_role_edit_view)|ai_kb_member_role_edit_view|设置角色|实体选项操作视图||
|[知识库检索记录编辑视图](app/view/ai_kb_search_query_edit_view)|ai_kb_search_query_edit_view|知识库检索记录|实体编辑视图|系统自动添加|
|[知识库标签编辑视图](app/view/ai_kb_tag_edit_view)|ai_kb_tag_edit_view|标签|实体编辑视图|系统自动添加|
|[知识库标签](app/view/ai_kb_tag_nested_grid_view)|ai_kb_tag_nested_grid_view|标签|实体表格视图||
|[标签](app/view/ai_kb_tag_quick_create_view)|ai_kb_tag_quick_create_view|标签|实体选项操作视图||
|[知识库标签集编辑视图](app/view/ai_kb_tag_set_edit_view)|ai_kb_tag_set_edit_view|标签集|实体编辑视图||
|[知识库标签集表格视图](app/view/ai_kb_tag_set_grid_view)|ai_kb_tag_set_grid_view|标签集|实体表格视图||
|[标签集](app/view/ai_kb_tag_set_quick_create_view)|ai_kb_tag_set_quick_create_view|标签集|实体编辑视图||
|[知识库](app/view/ai_knowledge_base_actived_grid_view)|ai_knowledge_base_actived_grid_view|知识库|实体表格视图||
|[高级设置](app/view/ai_knowledge_base_advanced_setting_view)|ai_knowledge_base_advanced_setting_view|高级设置|实体编辑视图||
|[基本信息编辑](app/view/ai_knowledge_base_base_info_edit_view)|ai_knowledge_base_base_info_edit_view|基本信息|实体编辑视图||
|[知识库信息视图](app/view/ai_knowledge_base_base_info_view)|ai_knowledge_base_base_info_view|知识库信息|实体编辑视图||
|[知识库切片策略视图](app/view/ai_knowledge_base_chunk_view)|ai_knowledge_base_chunk_view|高级配置|实体编辑视图||
|[切片策略](app/view/ai_knowledge_base_chunking_view_readonly)|ai_knowledge_base_chunking_view_readonly|切片策略|实体编辑视图|视图表单内容只读|
|[知识库实体配置中心视图](app/view/ai_knowledge_base_config_tree_exp_view2)|ai_knowledge_base_config_tree_exp_view2|配置中心|实体树导航视图||
|[新建知识库](app/view/ai_knowledge_base_create_wizard_view)|ai_knowledge_base_create_wizard_view|新建知识库|实体向导视图||
|[知识库](app/view/ai_knowledge_base_deleted_grid_view)|ai_knowledge_base_deleted_grid_view|知识库|实体表格视图||
...
|[管理后台](app/view/ai_knowledge_base_manage_tab_exp_view)|ai_knowledge_base_manage_tab_exp_view|管理后台|实体分页导航视图||
|[配置中心管理分页](app/view/ai_knowledge_base_management_tab_exp_view)|ai_knowledge_base_management_tab_exp_view|知识库|实体分页导航视图||
...
|[知识库](app/view/ai_knowledge_base_quick_create_view)|ai_knowledge_base_quick_create_view|知识库|实体选项操作视图||
|[召回策略](app/view/ai_knowledge_base_recall_view)|ai_knowledge_base_recall_view|召回策略|实体编辑视图||
|[知识库配置](app/view/ai_knowledge_base_setting_view)|ai_knowledge_base_setting_view|知识库配置|实体编辑视图（左右关系）||
...
|[知识库源](app/view/ai_knowledge_source_quick_create_view)|ai_knowledge_source_quick_create_view|知识库源|实体编辑视图||
|[AI大模型编辑视图](app/view/ai_model_edit_view)|ai_model_edit_view|AI大模型|实体编辑视图||
|[AI大模型表格视图](app/view/ai_model_grid_view)|ai_model_grid_view|AI大模型|实体表格视图||
...
|[AI大模型](app/view/ai_model_quick_create_view)|ai_model_quick_create_view|AI大模型|实体编辑视图||
|[AI调用工具编辑视图](app/view/ai_tool_edit_view)|ai_tool_edit_view|AI调用工具|实体编辑视图||
|[AI调用工具表格视图](app/view/ai_tool_grid_view)|ai_tool_grid_view|AI调用工具|实体表格视图||
...
|[AI调用工具](app/view/ai_tool_quick_create_view)|ai_tool_quick_create_view|AI调用工具|实体编辑视图||
...
|[页面](app/view/article_page_model_show_view_pop_up)|article_page_model_show_view_pop_up|页面|实体编辑视图||
...
|[知识库文档](app/view/article_page_nested_doc_grid_view)|article_page_nested_doc_grid_view|知识库文档|实体表格视图||
...
|[类别编辑视图](app/view/category_edit_view)|category_edit_view|类别|实体编辑视图||
...
|[类别数据重定向视图](app/view/category_redirect_view)|category_redirect_view|类别|实体数据重定向视图|系统自动添加|
|[工作流](app/view/category_workflow_edit_view)|category_workflow_edit_view|工作流表|实体选项操作视图|系统自动添加|
|[流程设计](app/view/category_workflow_grid_view)|category_workflow_grid_view|流程设计|实体表格视图|系统自动添加|
...
|[客户实体主视图](app/view/customer_main_view_pop_up)|customer_main_view_pop_up|客户|实体编辑视图||
...
|[项目类型字典](app/view/dictionary_data_copy_project_type_list_view)|dictionary_data_copy_project_type_list_view|项目类型字典|实体列表视图||
...
|[扩展打印模板编辑视图](app/view/extend_print_templ_edit_view)|extend_print_templ_edit_view|扩展打印模板|实体编辑视图|系统自动添加|
|[扩展打印模板表格视图](app/view/extend_print_templ_grid_view)|extend_print_templ_grid_view|扩展打印模板|实体表格视图||
|[扩展打印模板](app/view/extend_print_templ_quick_cfg_view)|extend_print_templ_quick_cfg_view|扩展打印模板|实体选项操作视图||
...
|[文档解析记录](app/view/extend_scheduled_task_parsing_record_view)|extend_scheduled_task_parsing_record_view|文档解析记录|实体编辑视图||
...
|[需求](app/view/idea_main_view_pop_up)|idea_main_view_pop_up|需求|实体编辑视图||
...
|[需求数据选择视图](app/view/idea_pick_up_view)|idea_pick_up_view|需求|实体数据选择视图||
...
|[工单关联需求多项数据选择视图](app/view/idea_ticket_re_mpick_up_view)|idea_ticket_re_mpick_up_view|选择需求|实体多项数据选择视图（左右关系）|系统自动添加|
...
|[新建项目](app/view/project_create_wizard_from_template_view)|project_create_wizard_from_template_view|新建项目|实体向导视图|系统自动添加|
...
|[规则配置视图](app/view/psdelogicquick_cfg_view)|psdelogicquick_cfg_view|自动化规则|实体选项操作视图||
...
|[自动规则模板](app/view/psdelogictemplate_info_view)|psdelogictemplate_info_view|自动规则模板|实体自定义视图||
...
|[工作流版本设计](app/view/pswfversiondesign)|pswfversiondesign|工作流版本设计|实体子应用引用视图||
...
|[自定义重定向视图](app/view/recent_custom_redirect_view)|recent_custom_redirect_view|最近访问|实体数据重定向视图||
...
|[文档审批单](app/view/sys_todo_approval_grid_view)|sys_todo_approval_grid_view|文档审批单|实体表格视图||
|[零件审批单](app/view/sys_todo_approval_grid_view_part)|sys_todo_approval_grid_view_part|零件审批单|实体表格视图||
|[已处理事项](app/view/sys_todo_done_grid_view)|sys_todo_done_grid_view|已处理事项|实体表格视图|系统自动添加|
|[待办编辑视图](app/view/sys_todo_edit_view)|sys_todo_edit_view|待办|实体编辑视图|系统自动添加|
|[已办结事项](app/view/sys_todo_finish_grid_view)|sys_todo_finish_grid_view|已办结事项|实体表格视图|系统自动添加|
|[待处理事项](app/view/sys_todo_todo_grid_view)|sys_todo_todo_grid_view|待处理事项|实体表格视图||
...
|[用例](app/view/test_case_main_view_pop_up)|test_case_main_view_pop_up|用例|实体编辑视图|main|
...
|[产品关联工单多项选择视图](app/view/ticket_idea_re_ticket_pick_up_view)|ticket_idea_re_ticket_pick_up_view|选择工单|实体多项数据选择视图（左右关系）||
...
|[工单](app/view/ticket_main_view_pop_up)|ticket_main_view_pop_up|工单|实体编辑视图||
...
|[工单关联工单多项选择视图](app/view/ticket_re_self_mpick_up_view)|ticket_re_self_mpick_up_view|选择工单|实体多项数据选择视图（左右关系）||
...
|[基线规划工作项多项选择视图](app/view/work_item_baseline_mpick_up_view)|work_item_baseline_mpick_up_view|选择工作项|实体多项数据选择视图（左右关系）||
...
|[子工作项多项选择视图](app/view/work_item_choose_child_mpick_up_view)|work_item_choose_child_mpick_up_view|选择工作项|实体多项数据选择视图（左右关系）||
...
|[选择工作项](app/view/work_item_depend_mpick_up_view)|work_item_depend_mpick_up_view|选择工作项|实体多项数据选择视图（左右关系）||
|[工作项（动态）](app/view/work_item_dyna_create_view)|work_item_dyna_create_view|工作项|实体编辑视图|工作项新建视图（动态）|
|[混合工作项（动态）](app/view/work_item_dyna_hybrid_main_view)|work_item_dyna_hybrid_main_view|混合工作项|实体编辑视图|混合工作项主视图（动态）|
...
|[kanban工作项（动态）](app/view/work_item_dyna_kanban_main_view)|work_item_dyna_kanban_main_view|kanban工作项|实体编辑视图|kanban工作项主视图（动态）|
...
|[工作项（动态）](app/view/work_item_dyna_main_view_pop_up)|work_item_dyna_main_view_pop_up|工作项|实体编辑视图|工作项主视图（动态-模态弹出）|
...
|[scrum工作项（动态）](app/view/work_item_dyna_scrum_main_view)|work_item_dyna_scrum_main_view|scrum工作项|实体编辑视图|scrum工作项主视图（动态）|
...
|[瀑布工作项（动态）](app/view/work_item_dyna_waterfall_main_view)|work_item_dyna_waterfall_main_view|瀑布工作项|实体编辑视图|瀑布工作项主视图（动态）|
...
|[工作项部件表格视图](app/view/work_item_more_work_item_unit)|work_item_more_work_item_unit|更多工作项|实体表格视图||
...
|[个人工作项](app/view/work_item_my_assignee_gird_view_show)|work_item_my_assignee_gird_view_show|个人工作项|实体表格视图|系统自动添加|
...
|[其他实体关联工作项多项选择视图](app/view/work_item_others_re_view)|work_item_others_re_view|选择工作项|实体多项数据选择视图（左右关系）||
...
|[工作项选择表格视图](app/view/work_item_pick_up_grid_view_workload)|work_item_pick_up_grid_view_workload|工作项|实体选择表格视图（部件视图）||
...
|[规划工作项多项选择视图](app/view/work_item_plan_work_item_mpick_up_view)|work_item_plan_work_item_mpick_up_view|选择工作项|实体多项数据选择视图（左右关系）||
...
|[工作项关联工作项多项选择视图](app/view/work_item_re_self_mpick_up_view)|work_item_re_self_mpick_up_view|选择工作项|实体多项数据选择视图（左右关系）||
...
|[工作项类型](app/view/work_item_type_global_edit_view)|work_item_type_global_edit_view|工作项类型|实体选项操作视图||
...
|[工作项类型配置视图](app/view/work_item_type_quick_cfg_view)|work_item_type_quick_cfg_view|工作项类型|实体编辑视图||
|[工作项类型新建视图](app/view/work_item_type_quick_create_view)|work_item_type_quick_create_view|工作项类型|实体编辑视图||
...
|[工作台工时快速建立视图](app/view/workload_quick_create_view_workbench)|workload_quick_create_view_workbench|登记工时|实体选项操作视图||
