...
### 处理逻辑中使用脚本<sup class="footnote-symbol"> <font color=orange>[42]</font></sup>
...
|[工作项(WORK_ITEM)](module/ProjMgmt/work_item#处理逻辑)|[移出基线(shift_out_baseline)](module/ProjMgmt/work_item/logic/shift_out_baseline.md)|否|
...
### 处理逻辑中使用SQL调用<sup class="footnote-symbol"> <font color=orange>[88]</font></sup>
| 实体col200   | 处理逻辑col300  |
| --------   |------------|
...
### 界面逻辑中使用脚本<sup class="footnote-symbol"> <font color=orange>[195]</font></sup>
| 实体col200   | 界面逻辑col300  |
| --------   |------------|
...
|[看板(BOARD)](module/ProjMgmt/board#界面逻辑)|[看板删除后附加逻辑](module/ProjMgmt/board/uilogic/after_board_remove)|
...
|[关联(RELATION)](module/Base/relation#界面逻辑)|[触发计数器刷新](module/Base/relation/uilogic/refresh_counter)|
|[评审(REVIEW)](module/TestMgmt/review#界面逻辑)|[计算表格列行为状态(project)](module/TestMgmt/review/uilogic/calc_column_action_state)|
...
|[评审(REVIEW)](module/TestMgmt/review#界面逻辑)|[跳转至工作流编辑视图](module/TestMgmt/review/uilogic/jump_wf_edit_view)|
...
| 实体col200   | 数据集合col300  |
| --------   |------------|
|[测试计划(TEST_PLAN)](module/TestMgmt/test_plan)|[测试报告概览(test_plan_report_survey)](module/TestMgmt/test_plan/dataset/test_plan_report_survey)|

### 未配置权限请求接口<sup class="footnote-symbol"> <font color=orange>[2]</font></sup>
| 实体col200| 请求路径col500| 请求方式col100   |    行为/集合col300    |
| -------- |-------- | --------|-------- |
|[页面(PAGE)](module/Wiki/article_page.md)|/article_pages/{key}/commit_version|POST|[生成版本(commit_version)](module/Wiki/article_page#行为)|
|[最近访问(RECENT)](module/Base/recent.md)|/recents/{key}/recent_clean|POST|[定时清理最近访问数据(recent_clean)](module/Base/recent#行为)|

### NONE权限请求接口<sup class="footnote-symbol"> <font color=orange>[184]</font></sup>
| 实体col200| 请求路径col500| 请求方式col100   |    行为/集合col300    |
| -------- |-------- | --------|-------- |
...
|[客户(CUSTOMER)](module/ProdMgmt/customer.md)|/customers/{key}/delete_categories|POST|[删除类别(delete_categories)](module/ProdMgmt/customer#行为)|
...
| 实体col200   | 操作标识col300  |
| --------   |------------|
|[评审内容(REVIEW_CONTENT)](module/TestMgmt/review_content.md)|CREATE<br>READ<br>DELETE<br>UPDATE|
|[基线(BASELINE)](module/Base/baseline.md)|CREATE<br>READ<br>DELETE<br>UPDATE|
...
### 除主键、主信息、预置属性外，不包含其他配置的表格<sup class="footnote-symbol"> <font color=orange>[26]</font></sup>
...
### 无搜索项的搜索表单<sup class="footnote-symbol"> <font color=orange>[50]</font></sup>
...
|[评审(REVIEW)](module/TestMgmt/review)|待办全部评审表格视图_搜索表单(todo_all_grid_view_search_form)|[全部评审(review_all_grid_view)](app/view/review_all_grid_view)|
...
|[空间(SPACE)](module/Wiki/space)|空间管理表格视图_进行中_搜索表单(usr02274660_search_form)|[空间管理(space_archived_grid_view)](app/view/space_archived_grid_view)|
...
### 除主键、主信息、预置属性外，不包含其他配置的表单<sup class="footnote-symbol"> <font color=orange>[43]</font></sup>
...
|[基线(BASELINE)](module/Base/baseline)|主编辑表单(main)|[基线(baseline_edit_view)](app/view/baseline_edit_view)|
...
|[评审内容(REVIEW_CONTENT)](module/TestMgmt/review_content)|评审结果选项操作视图_表单(result_option_view_form)|[评审内容(review_content_edit_view)](app/view/review_content_edit_view)|
...
|[用例(TEST_CASE)](module/TestMgmt/test_case)|附件_表单(attachment_form)|[选择模板(test_case_choose_template_option_view)](app/view/test_case_choose_template_option_view)|
