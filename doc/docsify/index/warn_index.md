...
### 处理逻辑中使用脚本<sup class="footnote-symbol"> <font color=orange>[172]</font></sup>
...
### 处理逻辑中使用SQL调用<sup class="footnote-symbol"> <font color=orange>[142]</font></sup>
| 实体col200   | 处理逻辑col300  |
| --------   |------------|
...
### 界面逻辑中使用脚本<sup class="footnote-symbol"> <font color=orange>[344]</font></sup>
| 实体col200   | 界面逻辑col300  |
| --------   |------------|
...
|[需求(IDEA)](module/ProdMgmt/idea#界面逻辑)|[需求展示评论显隐控制](module/ProdMgmt/idea/uilogic/idea_comment_visible)|
...
|[工作项(WORK_ITEM)](module/ProjMgmt/work_item#界面逻辑)|[通知刷新](module/ProjMgmt/work_item/uilogic/refresh)|
...
### 包含长文本的查询<sup class="footnote-symbol"> <font color=orange>[111]</font></sup>
| 实体col200   | 数据查询col300  |
| --------   |------------|
...
### 除主键、主信息、预置属性外，不包含其他配置的表单<sup class="footnote-symbol"> <font color=orange>[73]</font></sup>
