...
|[团队(GROUP)](module/Base/group)|[成员(MEMBER)](module/Base/member)|[DERCUSTOM_MEMBER_GROUP](der/DERCUSTOM_MEMBER_GROUP)|自定义关系||
...
|[测试库(LIBRARY)](module/TestMgmt/library)|[评审(REVIEW)](module/TestMgmt/review)|[DER1N_REVIEW_LIBRARY_LIBRARY_ID](der/DER1N_REVIEW_LIBRARY_LIBRARY_ID)|1:N关系||
...
|[页面(PAGE)](module/Wiki/article_page)|[版本（temp）(VERSION)](module/Base/version)|[DERCUSTOM_VERSION_PAGE](der/DERCUSTOM_VERSION_PAGE)|自定义关系||
...
|[工作项(WORK_ITEM)](module/ProjMgmt/work_item)|[版本（temp）(VERSION)](module/Base/version)|[DERCUSTOM_VERSION_WORK_ITEM](der/DERCUSTOM_VERSION_WORK_ITEM)|自定义关系||
