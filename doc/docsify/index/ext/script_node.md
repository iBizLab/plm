...
```
#### [知识库文档(AI_KB_DOCUMENT)](module/ai/ai_kb_document)的处理逻辑[生成文档执行计划(generate_doc_scheduled)](module/ai/ai_kb_document/logic/generate_doc_scheduled)
...
_extend_schedule.timer_policy = frequencyMap[sync_frequency]
```
#### [知识库文档同步(AI_KB_DOCUMENT_SYNC)](module/ai/ai_kb_document_sync)的处理逻辑[生成空间执行计划(generate_space_scheduled)](module/ai/ai_kb_document_sync/logic/generate_space_scheduled)
