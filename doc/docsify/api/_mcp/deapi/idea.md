...
<el-alert title="/ideas/fetch_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
查询全部产品需求信息，可以根据product_id查询特定产品的需求信息，排序可以指定create_time或update_time，模糊搜索可以根据title/description来LIKE匹配
