...
<el-alert title="/article_pages/fetch_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
|<el-row justify="space-between"><el-col :span="20">n_is_shared_subset_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|是否同时共享子页面|
