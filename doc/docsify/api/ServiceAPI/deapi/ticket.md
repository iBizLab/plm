...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/customer_choose_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/{key}/get_ai_full_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/{key}/get_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/others_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/fetch_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
查询全部工单信息，可以根据product_id查询特定产品的工单信息，排序可以指定create_time或update_time，模糊搜索可以根据title/description来LIKE匹配
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/fetch_ideas_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/fetch_my_submit" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/tickets/fetch_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/customer_choose_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/{key}/get_ai_full_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/{key}/get_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/others_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/fetch_ai_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
查询全部工单信息，可以根据product_id查询特定产品的工单信息，排序可以指定create_time或update_time，模糊搜索可以根据title/description来LIKE匹配
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/fetch_ideas_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/fetch_my_submit" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/products/{pkey}/tickets/fetch_relation_ticket" type="info" :closable="false" ></el-alert>
</div>
</el-row>
