...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/{key}/change_admin_role" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/{key}/library_index_addon_counter" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/{key}/move_library" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/fetch_main" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/fetch_mob_main" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/fetch_quick" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/libraries/fetch_quick_user" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
