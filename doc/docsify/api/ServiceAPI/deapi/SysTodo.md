...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/systodos/{key}/delundo" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
|字段col300|类型col150|备注col400|
|---|---|----|
|<el-row justify="space-between"><el-col :span="20">n_dcsystemid_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|租户系统标识|
...
|<el-row justify="space-between"><el-col :span="20">n_todosubtype_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|待办子类|
