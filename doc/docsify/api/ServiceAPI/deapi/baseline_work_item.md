# 基线工作项(baseline_work_item) :id=baseline_work_item
## 创建基线工作项
...
<el-alert title="/baseline_work_items" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">project_id</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|项目|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/fetch_baseline_comparison" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/fetch_baseline_relation_version" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/fetch_fill_version_data" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/exportdata/{param},/baseline_work_items/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baseline_work_items/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/shift_in_baseline" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/{key}/snapshot_set_baseline" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/fetch_baseline_comparison" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/fetch_baseline_relation_version" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/fetch_fill_version_data" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/exportdata/{param},/baselines/{pkey}/baseline_work_items/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/baselines/{pkey}/baseline_work_items/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
