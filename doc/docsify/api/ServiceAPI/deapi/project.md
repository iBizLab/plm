...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{key}/other_re_project" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{key}/other_re_space" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
