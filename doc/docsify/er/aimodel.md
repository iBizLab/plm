...
entity "AI_KB_TAG_SET\n知识库标签集" as AI_KB_TAG_SET [[$../module/ai/ai_kb_tag_set {知识库标签集}]] {
        <&key> ID - 标识
        --
}
entity "AI_KNOWLEDGE_BASE\n知识库" as AI_KNOWLEDGE_BASE [[$../module/ai/ai_knowledge_base {知识库}]] {
        ...
        <&link-intact> RERANK_MODEL_ID - 模型标识
        <&link-intact> EMBEDDING_MODEL_ID - 模型标识
...
AI_KB_TAG--> AI_KB_TAG_SET : [[$../der/DER1N_AI_KB_TAG_AI_KB_TAG_SET_SET_ID{DER1N_AI_KB_TAG_AI_KB_TAG_SET_SET_ID} 1:N关系]]
AI_AGENT_CONTEXT--> AI_KNOWLEDGE_BASE : [[$../der/DER1N_AI_AGENT_CONTEXT_AI_KNOWLEDGE_BASE_SPEC_KB_ID{DER1N_AI_AGENT_CONTEXT_AI_KNOWLEDGE_BASE_SPEC_KB_ID} 1:N关系]]
...
AI_AGENT--> AI_MODEL : [[$../der/DER1N_AI_AGENT_AI_MODEL_RERANK_MODEL_ID{DER1N_AI_AGENT_AI_MODEL_RERANK_MODEL_ID} 1:N关系]]
...
AI_AGENT_CONTEXT--> AI_MODEL : [[$../der/DER1N_AI_AGENT_CONTEXT_AI_MODEL_RERANK_MODEL_ID{DER1N_AI_AGENT_CONTEXT_AI_MODEL_RERANK_MODEL_ID} 1:N关系]]
AI_KNOWLEDGE_BASE--> AI_MODEL : [[$../der/DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_CHAT_MODEL_ID{DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_CHAT_MODEL_ID} 1:N关系]]
AI_KNOWLEDGE_BASE--> AI_MODEL : [[$../der/DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_EMBEDDING_MODEL_ID{DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_EMBEDDING_MODEL_ID} 1:N关系]]
AI_KNOWLEDGE_BASE--> AI_MODEL : [[$../der/DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_RERANK_MODEL_ID{DER1N_AI_KNOWLEDGE_BASE_AI_MODEL_RERANK_MODEL_ID} 1:N关系]]
