...
state "实体行为" as DEACTION1  [[$./un_attention#deaction1 {"实体行为"}]]
...
调用实体 [关注(ATTENTION)](module/Base/attention.md) 行为 [Remove](module/Base/attention#行为) ，行为参数为`Default(传入变量)`
