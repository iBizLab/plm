...
|------------| -----   |  -------- | -------- |-------- |-------- |
|[通知取消工作项分配执行人](module/Base/executor/notify/cancel_work_item_executor)|cancel_work_item_executor|[默认消息队列](index/notify_index)|[取消分配执行工作项通知模板](index/notify_index#cancel_executor_work_item)|执行人 ||
|[通知工作项执行人](module/Base/executor/notify/work_item_executor)|work_item_executor|[默认消息队列](index/notify_index)|[分配执行工作项通知模板](index/notify_index#notice_executor_work_item)|执行人 ||
