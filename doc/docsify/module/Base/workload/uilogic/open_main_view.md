...
state "获取工作项" as DEACTION1  [[$./open_main_view#deaction1 {获取工作项}]]
...
state "调试逻辑参数" as DEBUGPARAM1  [[$./open_main_view#debugparam1 {调试逻辑参数}]]
state "打开产品需求主视图" as DEUIACTION3  [[$./open_main_view#deuiaction3 {打开产品需求主视图}]]
state "准备参数" as PREPAREJSPARAM1  [[$./open_main_view#preparejsparam1 {准备参数}]]
...
2. 将`Default(传入变量).recent_parent` 设置给  `work_item(工作项).project_id`
