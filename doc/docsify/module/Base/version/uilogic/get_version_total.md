...
state "开始" as Begin <<start>> [[$./get_version_total#begin {开始}]]
state "设置总条数" as RAWJSCODE1  [[$./get_version_total#rawjscode1 {设置总条数}]]
state "结束" as END1 <<end>> [[$./get_version_total#end1 {结束}]]
