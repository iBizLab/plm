...
state "开始" as Begin <<start>> [[$./product_create_category#begin {开始}]]
state "视图部件调用" as VIEWCTRLINVOKE1  [[$./product_create_category#viewctrlinvoke1 {视图部件调用}]]
state "准备参数" as PREPAREJSPARAM1  [[$./product_create_category#preparejsparam1 {准备参数}]]
