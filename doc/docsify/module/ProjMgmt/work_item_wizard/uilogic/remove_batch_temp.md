...
state "批量删除临时数据" as RAWJSCODE1  [[$./remove_batch_temp#rawjscode1 {批量删除临时数据}]]
...
#### 批量删除临时数据 :id=RAWJSCODE1<sup class="footnote-symbol"> <font color=gray size=1>[直接前台代码]</font></sup>
