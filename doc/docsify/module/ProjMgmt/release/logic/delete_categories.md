...
state "当类别删除时修改发布的类别属性" as RAWSQLCALL1  [[$./delete_categories#rawsqlcall1 {"当类别删除时修改发布的类别属性"}]]
...
#### 当类别删除时修改发布的类别属性 :id=RAWSQLCALL1<sup class="footnote-symbol"> <font color=gray size=1>[直接SQL调用]</font></sup>
