## Waterfall项目-需求-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./waterfall_requirement#mainstate1 {"打开"}]]
state "规划中" as MAINSTATE5  [[$./waterfall_requirement#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./waterfall_requirement#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./waterfall_requirement#mainstate2 {"进行中"}]]
state "已完成" as MAINSTATE3  [[$./waterfall_requirement#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./waterfall_requirement#mainstate4 {"挂起"}]]
