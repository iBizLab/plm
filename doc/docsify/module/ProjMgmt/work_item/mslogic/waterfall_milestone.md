## Waterfall项目-里程碑-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./waterfall_milestone#mainstate1 {"打开"}]]
state "已完成" as MAINSTATE3  [[$./waterfall_milestone#mainstate3 {"已完成"}]]
