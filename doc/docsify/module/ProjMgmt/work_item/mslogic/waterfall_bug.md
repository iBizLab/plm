## Waterfall项目-缺陷-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./waterfall_bug#mainstate1 {"打开"}]]
state "规划中" as MAINSTATE5  [[$./waterfall_bug#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./waterfall_bug#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./waterfall_bug#mainstate2 {"进行中"}]]
state "开发完成" as MAINSTATE8  [[$./waterfall_bug#mainstate8 {"开发完成"}]]
state "测试中" as MAINSTATE9  [[$./waterfall_bug#mainstate9 {"测试中"}]]
state "测试通过" as MAINSTATE10  [[$./waterfall_bug#mainstate10 {"测试通过"}]]
state "测试失败" as MAINSTATE11  [[$./waterfall_bug#mainstate11 {"测试失败"}]]
state "已完成" as MAINSTATE3  [[$./waterfall_bug#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./waterfall_bug#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./waterfall_bug#mainstate7 {"被拒绝"}]]
