## Kanban项目-史诗-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./kanban_epic#mainstate1 {"打开"}]]
state "规划中" as MAINSTATE5  [[$./kanban_epic#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./kanban_epic#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./kanban_epic#mainstate2 {"进行中"}]]
state "已完成" as MAINSTATE3  [[$./kanban_epic#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./kanban_epic#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./kanban_epic#mainstate7 {"被拒绝"}]]
