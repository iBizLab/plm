## Hybrid项目-用户故事-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./hybrid_story#mainstate1 {"打开"}]]
state "规划中" as MAINSTATE5  [[$./hybrid_story#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./hybrid_story#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./hybrid_story#mainstate2 {"进行中"}]]
state "已完成" as MAINSTATE3  [[$./hybrid_story#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./hybrid_story#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./hybrid_story#mainstate7 {"被拒绝"}]]
