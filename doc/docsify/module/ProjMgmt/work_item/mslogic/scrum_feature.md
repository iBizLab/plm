## Scrum项目-特性-状态迁移 <!-- {docsify-ignore-all} -->
...
state "规划中" as MAINSTATE5  [[$./scrum_feature#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./scrum_feature#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./scrum_feature#mainstate2 {"进行中"}]]
state "已完成" as MAINSTATE3  [[$./scrum_feature#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./scrum_feature#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./scrum_feature#mainstate7 {"被拒绝"}]]
