## Kanban项目-特性-状态迁移 <!-- {docsify-ignore-all} -->
...
hide empty description
state "打开" as MAINSTATE1  [[$./kanban_feature#mainstate1 {"打开"}]]
state "规划中" as MAINSTATE5  [[$./kanban_feature#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./kanban_feature#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./kanban_feature#mainstate2 {"进行中"}]]
state "已完成" as MAINSTATE3  [[$./kanban_feature#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./kanban_feature#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./kanban_feature#mainstate7 {"被拒绝"}]]
