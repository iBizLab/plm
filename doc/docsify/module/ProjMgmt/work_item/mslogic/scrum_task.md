...
state "规划中" as MAINSTATE5  [[$./scrum_task#mainstate5 {"规划中"}]]
state "规划完成" as MAINSTATE6  [[$./scrum_task#mainstate6 {"规划完成"}]]
state "进行中" as MAINSTATE2  [[$./scrum_task#mainstate2 {"进行中"}]]
state "开发完成" as MAINSTATE8  [[$./scrum_task#mainstate8 {"开发完成"}]]
state "测试中" as MAINSTATE9  [[$./scrum_task#mainstate9 {"测试中"}]]
state "测试通过" as MAINSTATE10  [[$./scrum_task#mainstate10 {"测试通过"}]]
state "测试失败" as MAINSTATE11  [[$./scrum_task#mainstate11 {"测试失败"}]]
state "已完成" as MAINSTATE3  [[$./scrum_task#mainstate3 {"已完成"}]]
state "挂起" as MAINSTATE4  [[$./scrum_task#mainstate4 {"挂起"}]]
state "被拒绝" as MAINSTATE7  [[$./scrum_task#mainstate7 {"被拒绝"}]]
