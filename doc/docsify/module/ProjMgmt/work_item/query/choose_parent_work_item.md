## 选择父工作项(choose_parent_work_item) <!-- {docsify-ignore-all} -->
...
### 查询连接
* **WORK_ITEM_TYPE相关N:1（INNER JOIN）DER1N_WORK_ITEM_WORK_ITEM_TYPE_WORK_ITEM_TYPE_ID**<br>
连接关系：[DER1N_WORK_ITEM_WORK_ITEM_TYPE_WORK_ITEM_TYPE_ID](der/DER1N_WORK_ITEM_WORK_ITEM_TYPE_WORK_ITEM_TYPE_ID)<br>
连接实体：[工作项类型](module/ProjMgmt/work_item_type)<br>
连接条件：(`SUB_TYPE(下级类型)` LIKE `网页请求上下文.work_item_type_id`)<br>
