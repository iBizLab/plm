...
state "开始" as Begin <<start>> [[$./notify_refresh_mob#begin {开始}]]
state "结束" as END1 <<end>> [[$./notify_refresh_mob#end1 {结束}]]
state "通知刷新" as RAWJSCODE1  [[$./notify_refresh_mob#rawjscode1 {通知刷新}]]
