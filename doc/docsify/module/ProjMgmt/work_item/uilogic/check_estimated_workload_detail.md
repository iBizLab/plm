...
state "开始" as Begin <<start>> [[$./check_estimated_workload_detail#begin {开始}]]
state "切换显示组件" as RAWJSCODE1  [[$./check_estimated_workload_detail#rawjscode1 {切换显示组件}]]
