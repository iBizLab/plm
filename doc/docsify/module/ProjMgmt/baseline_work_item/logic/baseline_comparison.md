...
state "工作项cur_version_ids" as RAWSFCODE2  [[$./baseline_comparison#rawsfcode2 {"工作项cur_version_ids"}]]
...
#### 工作项cur_version_ids :id=RAWSFCODE2<sup class="footnote-symbol"> <font color=gray size=1>[直接后台代码]</font></sup>
...
|工作项循环临时变量|work_item_for_temp|数据对象|[工作项(WORK_ITEM)](module/ProjMgmt/work_item.md)||
