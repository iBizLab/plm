...
|变更职位|change_position|[实体处理逻辑](module/ProjMgmt/project_member/logic/change_position "变更职位")|默认|不支持||||
...
| 打开人员选择视图（移动端） | open_user_view | 打开人员选择视图 |无数据|<details><summary>打开视图或向导（模态）</summary>[项目成员](app/view/project_member_mob_pickup_view)</details>||
