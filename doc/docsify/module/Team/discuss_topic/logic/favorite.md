...
Begin --> PREPAREPARAM1 : [[$./favorite#begin-prepareparam1{存在星标数据标识} 存在星标数据标识]]
...
2. 将`discuss_topic` 设置给  `favorite(收藏对象).OWNER_TYPE(所属数据对象)`
...
### 连接条件说明
#### 存在星标数据标识 :id=Begin-PREPAREPARAM1
