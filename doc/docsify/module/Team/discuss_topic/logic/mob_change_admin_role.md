## 变更管理员角色（移动端） <!-- {docsify-ignore-all} -->
...
hide empty description
state "开始" as Begin <<start>> [[$./mob_change_admin_role#begin {"开始"}]]
state "绑定参数" as BINDPARAM1  [[$./mob_change_admin_role#bindparam1 {"绑定参数"}]]
state "结束" as END1 <<end>> [[$./mob_change_admin_role#end1 {"结束"}]]
state "循环子调用" as LOOPSUBCALL1  [[$./mob_change_admin_role#loopsubcall1 {"循环子调用"}]] #green {
state "重新建立更新成员信息参数" as RENEWPARAM4  [[$./mob_change_admin_role#renewparam4 {"重新建立更新成员信息参数"}]]
state "准备更新管理员身份" as PREPAREPARAM2  [[$./mob_change_admin_role#prepareparam2 {"准备更新管理员身份"}]]
state "更新管理员身份" as DEACTION1  [[$./mob_change_admin_role#deaction1 {"更新管理员身份"}]]
}


Begin --> BINDPARAM1
BINDPARAM1 --> LOOPSUBCALL1 : [[$./mob_change_admin_role#bindparam1-loopsubcall1{有勾选添加成员} 有勾选添加成员]]
LOOPSUBCALL1 --> RENEWPARAM4
RENEWPARAM4 --> PREPAREPARAM2
PREPAREPARAM2 --> DEACTION1
LOOPSUBCALL1 --> END1
BINDPARAM1 --> END1 : [[$./mob_change_admin_role#bindparam1-end1{未勾选添加成员} 未勾选添加成员]]
...
调用实体 [协作成员(DISCUSS_MEMBER)](module/Team/discuss_member.md) 行为 [Save](module/Team/discuss_member#行为) ，行为参数为`update_member_info(更新成员信息)`
...
|更新成员信息|update_member_info|数据对象|[协作成员(DISCUSS_MEMBER)](module/Team/discuss_member.md)||
