...
state "开始" as Begin <<start>> [[$./mob_refresh#begin {开始}]]
state "通知刷新" as RAWJSCODE1  [[$./mob_refresh#rawjscode1 {通知刷新}]]
state "结束" as END1 <<end>> [[$./mob_refresh#end1 {结束}]]
