...
调用实体 [知识库成员(AI_KB_MEMBER)](module/ai/ai_kb_member.md) 行为 [Update](module/ai/ai_kb_member#行为) ，行为参数为`Default(传入变量)`
...
|循环临时变量|for_temp_obj|数据对象|[知识库成员(AI_KB_MEMBER)](module/ai/ai_kb_member.md)||
|选择数据对象|srfactionparam|数据对象列表|[知识库成员(AI_KB_MEMBER)](module/ai/ai_kb_member.md)||
