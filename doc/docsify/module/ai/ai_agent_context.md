...
|智能体工作流模式|FLOW_MODE|[单项选择(文本值)](index/dictionary_index#flow_mode "智能体工作流模式")|60|是||
...
| --------| --------| -------- |------------|------------|------------|
| 模版填充 | template | 上下文模版智能生成 |单项数据|<details><summary>打开聊天界面</summary></details>||
