...
hide empty description
state "开始" as Begin <<start>> [[$./generate_space_scheduled#begin {"开始"}]]
state "准备参数" as PREPAREPARAM_01  [[$./generate_space_scheduled#prepareparam_01 {"准备参数"}]]
state "构造定时器策略" as RAWSFCODE_01  [[$./generate_space_scheduled#rawsfcode_01 {"构造定时器策略"}]]
state "创建空间执行计划" as DEACTION_01  [[$./generate_space_scheduled#deaction_01 {"创建空间执行计划"}]]
...
*- N/A*
#### 创建空间执行计划 :id=DEACTION_01<sup class="footnote-symbol"> <font color=gray size=1>[实体行为]</font></sup>
