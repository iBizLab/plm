...
state "设置重要程度参数" as PREPAREPARAM2  [[$./set_level#prepareparam2 {"设置重要程度参数"}]]
...
#### 设置重要程度参数 :id=PREPAREPARAM2<sup class="footnote-symbol"> <font color=gray size=1>[准备参数]</font></sup>
