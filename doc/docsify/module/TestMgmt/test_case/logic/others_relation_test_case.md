...
state "绑定参数" as BINDPARAM1  [[$./others_relation_test_case#bindparam1 {"绑定参数"}]]
...
state "重新建立参数" as RENEWPARAM1  [[$./others_relation_test_case#renewparam1 {"重新建立参数"}]]
state "重新建立参数" as RENEWPARAM2  [[$./others_relation_test_case#renewparam2 {"重新建立参数"}]]
