...
| --------   |------------| -----  | -----  | :----: | -------- |
|后置动作|ACTION_RULE|外键值附加数据|1048576|是||
...
|规则|RULE|外键值附加数据|1048576|是||
|编号|SHOW_IDENTIFIER|文本，可指定长度|200|是||
|阶段|STAGE|外键值附加数据|1048576|是||
...
| --------| --------| -------- |------------|------------|------------|
| 撤回评审 | toolbar_main_view_toolbar_deuiaction2_click | 撤回评审 |单项数据|用户自定义||
| 编辑 | toolbar_tree_exp_view_node8_cm_deuiaction1_click | 编辑 |单项数据|用户自定义||
| 打开编辑视图 | open_edit_view | 打开流程视图 |单项数据（主键）|<details><summary>打开视图或向导（模态）</summary>[评审](app/view/review_main_view)</details>||
| 添加附件 | add_attachments | 添加附件 |无数据|用户自定义||
| 撤销评审 | repeal_review | 撤销评审 |单项数据|系统预定义||
...
| 提交评审 | toolbar_main_view_toolbar_deuiaction1_click | 提交评审 |单项数据|用户自定义||
