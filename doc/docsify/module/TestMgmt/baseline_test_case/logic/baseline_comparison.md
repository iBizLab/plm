...
state "用例cur_version_ids" as RAWSFCODE2  [[$./baseline_comparison#rawsfcode2 {"用例cur_version_ids"}]]
...
#### 用例cur_version_ids :id=RAWSFCODE2<sup class="footnote-symbol"> <font color=gray size=1>[直接后台代码]</font></sup>
