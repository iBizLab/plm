...
hide empty description
state "开始" as Begin <<start>> [[$./product_re_space#begin {"开始"}]]
state "结束" as END1 <<end>> [[$./product_re_space#end1 {"结束"}]]
state "设置正/反向关联参数" as PREPAREPARAM1  [[$./product_re_space#prepareparam1 {"设置正/反向关联参数"}]]
state "生成正向关联数据" as DEACTION1  [[$./product_re_space#deaction1 {"生成正向关联数据"}]]
state "生成反向关联数据" as DEACTION2  [[$./product_re_space#deaction2 {"生成反向关联数据"}]]
state "抛出异常" as THROWEXCEPTION1  [[$./product_re_space#throwexception1 {"抛出异常"}]]


Begin --> PREPAREPARAM1 : [[$./product_re_space#begin-prepareparam1{存在关联主要标识} 存在关联主要标识]]
PREPAREPARAM1 --> DEACTION1
DEACTION1 --> DEACTION2
DEACTION2 --> END1
Begin --> THROWEXCEPTION1 : [[$./product_re_space#begin-throwexception1{无值} 无值]]
...
#### 设置正/反向关联参数 :id=PREPAREPARAM1<sup class="footnote-symbol"> <font color=gray size=1>[准备参数]</font></sup>
