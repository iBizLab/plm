...
state "删除基线-页面关联数据" as DEACTION1  [[$./shift_out_baseline#deaction1 {"删除基线-页面关联数据"}]]
...
*- N/A*
#### 删除基线-页面关联数据 :id=DEACTION1<sup class="footnote-symbol"> <font color=gray size=1>[实体行为]</font></sup>
