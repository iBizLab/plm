...
state "设置默认排序值" as RAWSFCODE_01  [[$./publish_page#rawsfcode_01 {"设置默认排序值"}]]
...
PREPAREPARAM4 --> RAWSFCODE_01
RAWSFCODE_01 --> PREPAREPARAM2
...
PREPAREPARAM5 --> RAWSFCODE_01 : [[$./publish_page#prepareparam5-rawsfcode_01{未发布} 未发布]]
...
#### 设置默认排序值 :id=RAWSFCODE_01<sup class="footnote-symbol"> <font color=gray size=1>[直接后台代码]</font></sup>
...
#### 未发布 :id=PREPAREPARAM5-RAWSFCODE_01
