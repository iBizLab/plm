...
entity "PAGE_VERSION\n页面版本" as PAGE_VERSION [[$../module/Wiki/Page_version {页面版本}]] {
        <&key> ID - 标识
        --
        <&link-intact> PAGE_ID - 页面标识
}
...
PAGE_VERSION--> PAGE : [[$../der/DER1N_PAGE_VERSION_PAGE_PAGE_ID{DER1N_PAGE_VERSION_PAGE_PAGE_ID} 1:N关系]]
