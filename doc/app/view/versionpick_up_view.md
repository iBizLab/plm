# 版本（temp）(versionpick_up_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [版本（temp）(VERSION)](module/ProjMgmt/Version) : [视图_取消](module/ProjMgmt/Version#界面行为)
  * [版本（temp）(VERSION)](module/ProjMgmt/Version) : [视图_确定](module/ProjMgmt/Version#界面行为)
