...
const J = () => {
  ...
  let e = parseInt(t.substring(0, 2), 16), r = parseInt(t.substring(2, 4), 16), n = parseInt(t.substring(4, 6), 16);
  e < 0 && (e = 10), r < 0 && (r = 10), n < 0 && (n = 10);
  const m = "#".concat(e.toString(16).padStart(2, "0")).concat(r.toString(16).padStart(2, "0")).concat(n.toString(16).padStart(2, "0")).replaceAll("-", "0");
  return m === "#FFFFFF" && J() || m;
}, A = (s) => {
