...
export declare const CheckboxListExtend: import("vue").DefineComponent<{
    value: (StringConstructor | NumberConstructor)[];
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<CheckboxListExtendController>, undefined, undefined>;
    ...
    c: CheckboxListExtendController;
    editorRef: Ref<any>;
    items: Ref<readonly IData[]>;
    treeRef: Ref<import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        data: {
    ...
    defaultCheckedKeys: Ref<(string | number)[]>;
