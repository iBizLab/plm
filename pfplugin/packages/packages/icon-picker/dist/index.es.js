...
var Y = (a, r, i) => r in a ? N(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i }) : a[r] = i;
var p = (a, r, i) => (Y(a, typeof r != "symbol" ? r + "" : r, i), i);
import { EditorController as $, registerEditorProvider as K } from "@ibiz-template/runtime";
import { defineComponent as X, ref as f, computed as h, watch as x, createVNode as c, resolveComponent as u, mergeProps as Q, createTextVNode as q } from "vue";
import { getInputProps as _, getEditorEmits as J, useNamespace as Z } from "@ibiz-template/vue3-util";
import { RuntimeModelError as ee } from "@ibiz-template/core";
const O = /* @__PURE__ */ X({
  name: "IconPicker",
  props: _(),
  emits: J(),
  setup: (a, {
    ...
    const i = Z("icon-picker"), t = a.controller, l = t.model, d = f(!1), n = f(""), s = f(""), m = f(0), w = f(!1), k = f(), y = h(() => {
      switch (l.editorType) {
        case "TEXTBOX":
          return "text";
        case "PASSWORD":
    ...
    }), A = h(() => !!(a.controlParams && a.controlParams.editmode === "hover" && !a.readonly)), W = f("");
    t.initIconList(), x(() => a.value, (e, o) => {
      e !== o && (e == null ? (W.value = "", s.value = "") : (W.value = e.toString(), s.value = e.toString()));
    }, {
      immediate: !0
    });
    const v = (e) => {
    ...
    let g;
    const T = (e) => {
      g !== e && r("change", e), g = void 0;
    }, L = (e) => {
      e && e.code === "Enter" && (r("enter", e), k.value.$el.dispatchEvent(e));
    }, B = (e) => {
      g = e.target.value, g != a.value && r("change", g), r("blur", e), v(!1);
    };
    x(k, (e) => {
      if (a.autoFocus && e) {
        const o = y.value === "textarea" ? "textarea" : "input";
        e.$el.getElementsByTagName(o)[0].focus();
      }
    });
    const F = h(() => {
      if (t.iconList.length > 0) {
        const e = Number(m.value) || 0, o = t.iconList[e];
        let b = [];
        return o && o.children && (b = o.children), n.value && (b = b.filter((S) => {
          const j = "fa fa-".concat(S.id);
          return !!(S.id && j.includes(n.value));
        })), b;
      }
      return [];
    }), D = () => {
      ...
      let o = "".concat(a.controller.formatValue(W.value));
      return o && e && (o += e), o;
    }), M = h(() => t.model.editorParams && t.model.editorParams.autocomplete && t.toBoolean(t.model.editorParams.autocomplete) ? "on" : "new-password"), C = () => {
      n.value = "", m.value = 0, d.value = !1;
    }, U = () => {
      s.value && r("change", s.value), n.value = "", m.value = 0, d.value = !1;
    }, H = (e) => {
      m.value = e;
    }, R = (e) => {
      ...
      "default-active": String(m.value),
      mode: "horizontal",
      onSelect: H
    }, {
      default: () => t.iconList.map((e, o) => c(u("el-menu-item"), {
        title: e.label,
        key: o,
        index: o.toString()
      }, {
    ...
    return {
      ...
      onFocus: E,
      editorRef: k,
      shouldAutoComplete: M,
      isEditable: w,
      setEditable: v,
      iconSelectorState: d,
      renderIconModal: () => c(u("el-dialog"), {
        title: "请选择图标",
        modelValue: d.value,
  ...
  render() {
    ...
    let i = null;
    this.readonly ? i = this.readonlyText : i = c(u("el-input"), Q({
      ref: "editorRef",
      clearable: !0,
      modelValue: this.currentVal,
      "onUpdate:modelValue": (l) => this.currentVal = l,
    ...
    }, [this.currentVal ? this.type === "password" ? this.currentVal.split("").map((l) => "•") : this.currentVal : "-"]);
    return c("div", {
      ...
      style: {
        width: a ? "".concat(a, "px") : "",
        height: r ? "".concat(r, "px") : ""
      }
    }, [this.showFormDefaultContent && t, i, this.iconSelectorState && this.renderIconModal()]);
  }
}), ie = [
  {
    name: "Glass",
...
class ae extends $ {
  ...
  initIconList() {
    if (!P)
      throw new ee(this.model, "请配置实体和实体数据集");
    const { icons: i } = P;
    if (i && i.length > 0) {
      const t = [];
      i.forEach((l) => {
        l.categories.forEach((d) => {
          const n = t.findIndex(
...
class re {
  constructor() {
    p(this, "component", "IconPicker");
    p(this, "formEditor", "IconPicker");
    p(this, "gridEditor", "IconPicker");
  }
  async createController(r, i) {
    const t = new ae(r, i);
