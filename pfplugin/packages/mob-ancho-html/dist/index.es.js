...
import { defineComponent as se, ref as $, watch as ie, createVNode as k, resolveComponent as V, nextTick as ee, computed as be } from "vue";
import { useNamespace as oe, getRawProps as me, getEditorEmits as he } from "@ibiz-template/vue3-util";
  ...
  var a = function(u) {
    var c = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, S = 0, w = {}, o = {
        ...
        DFS: function t(n, s, i, l) {
          ...
          for (var I in n)
            if (n.hasOwnProperty(I)) {
              s.call(n, I, n[I], i || I);
              var y = n[I], F = o.util.type(y);
              F === "Object" && !l[E(y)] ? (l[E(y)] = !0, t(y, s, null, l)) : F === "Array" && !l[E(y)] && (l[E(y)] = !0, t(y, s, I, l));
            }
        }
      },
      plugins: {},
      ...
      tokenize: function(t, n) {
        ...
        var l = new f();
        return b(l, l.head, t), m(t, l, n, l.head, 0), T(l);
      },
      /**
       * @namespace
       * @memberof Prism
        ...
        if (!(!s.hasOwnProperty(I) || !s[I])) {
          ...
          for (var F = 0; F < y.length; ++F) {
            ...
            if (W && !N.pattern.global) {
              var Y = N.pattern.toString().match(/[imsuy]*$/)[0];
              N.pattern = RegExp(N.pattern.source, Y + "g");
            }
            for (var Z = N.pattern || N, C = i.next, R = l; C !== n.tail && !(E && R >= E.reach); R += C.value.length, C = C.next) {
              var P = C.value;
              ...
              if (!(P instanceof g)) {
                var z = 1, M;
                if (W) {
                  if (M = h(Z, R, t, G), !M || M.index >= t.length)
                    break;
                ...
                } else if (M = h(Z, 0, P, G), !M)
                  continue;
                var d = M.index, v = M[0], L = P.slice(0, d), B = P.slice(d + v.length), D = R + P.length;
                E && D > E.reach && (E.reach = D);
                var j = C.prev;
                L && (j = b(n, j, L), R += L.length), A(n, j, z);
                var q = new g(I, U ? o.tokenize(v, U) : v, K, v);
                if (C = b(n, j, q), B && b(n, C, B), z > 1) {
                  var X = {
                    cause: I + "," + F,
                    reach: D
                  };
                  m(t, n, s, C.prev, R, X), E && X.reach > E.reach && (E.reach = X.reach);
                }
              }
            }
          }
...
(function(e) {
  ...
  e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
    ...
    ["url", "bold", "italic", "strike", "code-snippet"].forEach(function(f) {
      m !== f && (e.languages.markdown[m].inside.content.inside[f] = e.languages.markdown[f]);
    });
    ...
    if (m.type === "code-block") {
      for (var f = "", b = 0, A = m.classes.length; b < A; b++) {
        var T = m.classes[b], _ = /language-(.+)/.exec(T);
        if (_) {
          f = _[1];
          break;
        }
      ...
      var O = e.languages[f];
      if (O)
        m.content = e.highlight(h(m.content), O, f);
      else if (f && f !== "none" && e.plugins.autoloader) {
        var x = "md-" + (/* @__PURE__ */ new Date()).valueOf() + "-" + Math.floor(Math.random() * 1e16);
        m.attributes.id = x, e.plugins.autoloader.loadLanguages(f, function() {
  ...
  function h(m) {
    ...
    return f = f.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(b, A) {
      if (A = A.toLowerCase(), A[0] === "#") {
        var T;
        return A[1] === "x" ? T = parseInt(A.slice(2), 16) : T = Number(A.slice(1)), g(T);
      } else {
        var _ = o[A];
        return _ || b;
      }
        ...
        if (a.language === u) {
          ...
          a.code = a.code.replace(c, function(o) {
            if (typeof S == "function" && !S(o))
              return o;
            for (var g = w.length, h; a.code.indexOf(h = r(u, g)) !== -1; )
              ++g;
            return w[g] = o, h;
        ...
        function w(o) {
          for (var g = 0; g < o.length && !(c >= S.length); g++) {
            ...
            if (typeof h == "string" || h.content && typeof h.content == "string") {
              var m = S[c], f = a.tokenStack[m], b = typeof h == "string" ? h : h.content, A = r(u, m), T = b.indexOf(A);
              if (T > -1) {
                ++c;
                var _ = b.substring(0, T), O = new e.Token(u, e.tokenize(f, a.grammar), "language-" + u, f), x = b.substring(T + A.length), t = [];
  ...
  var w = function(g) {
    ...
    for (var h = [], m = 0; m < g.length; m++) {
      ...
      if (typeof f != "string" && (f.type === "tag" && f.content[0] && f.content[0].type === "tag" ? f.content[0].content[0].content === "</" ? h.length > 0 && h[h.length - 1].tagName === w(f.content[0].content[1]) && h.pop() : f.content[f.content.length - 1].content === "/>" || h.push({
        ...
        openedBraces: 0
      }) : h.length > 0 && f.type === "punctuation" && f.content === "{" ? h[h.length - 1].openedBraces++ : h.length > 0 && h[h.length - 1].openedBraces > 0 && f.type === "punctuation" && f.content === "}" ? h[h.length - 1].openedBraces-- : b = !0), (b || typeof f == "string") && h.length > 0 && h[h.length - 1].openedBraces === 0) {
        var A = w(f);
        m < g.length - 1 && (typeof g[m + 1] == "string" || g[m + 1].type === "plain-text") && (A += w(g[m + 1]), g.splice(m + 1, 1)), m > 0 && (typeof g[m - 1] == "string" || g[m - 1].type === "plain-text") && (A = w(g[m - 1]) + A, g.splice(m - 1, 1), m--), g[m] = new e.Token("plain-text", A, null, A);
      }
...
(function(e) {
  ...
  var w = S(c.typeDeclaration), o = RegExp(S(c.type + " " + c.typeDeclaration + " " + c.contextual + " " + c.other)), g = S(c.typeDeclaration + " " + c.contextual + " " + c.other), h = S(c.type + " " + c.typeDeclaration + " " + c.other), m = u(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2), f = u(/\((?:[^()]|<<self>>)*\)/.source, 2), b = /@?\b[A-Za-z_]\w*\b/.source, A = r(/<<0>>(?:\s*<<1>>)?/.source, [b, m]), T = r(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [g, A]), _ = /\[\s*(?:,\s*)*\]/.source, O = r(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [T, _]), x = r(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [m, f, _]), t = r(/\(<<0>>+(?:,<<0>>+)+\)/.source, [x]), n = r(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [t, T, _]), s = {
    keyword: o,
    punctuation: /[<>()?,.:[\]]/
  ...
  e.languages.csharp = e.languages.extend("clike", {
    ...
    "class-name": [
      ...
      },
      {
        ...
        pattern: a(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [n, h, b]),
        inside: s
      }
    ],
    keyword: o,
  ...
  var I = l + "|" + i, y = r(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [I]), F = u(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [y]), 2), N = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, U = r(/<<0>>(?:\s*\(<<1>>*\))?/.source, [T, F]);
  e.languages.insertBefore("csharp", "class-name", {
    attribute: {
      // Attributes
  ...
  var G = /:[^}\r\n]+/.source, W = u(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [y]), 2), K = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [W, G]), Y = u(r(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [I]), 2), Z = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [Y, G]);
  function C(R, P) {
    return {
      interpolation: {
...
const te = /* @__PURE__ */ se({
  ...
  setup(e, {
    ...
    const g = (p) => /^https?:|^http?:|(\.png|\.svg|\.jpg|\.png|\.gif|\.psd|\.tif|\.bmp|\.jpeg)/.test(p), h = $({
      id: ne(),
      path: "",
      mute: !0,
      autoplay: !0,
    ...
    const i = $(!1), l = (p) => e.parseScript ? de.execScriptFn({
      ...
      const q = j.trim(), X = JSON.stringify({
        id: v,
        name: L,
        identifier: B,
        type: D
      });
      return "<span markerClick='marker' params='".concat(X, "' class='comment-tag is-click'>").concat(q, " ").concat(B, " ").concat(L, "</span>");
    ...
    }), I = (p) => p.replaceAll(/<span\sdata-w-e-type="insert"\sclass=['"]insert['"]>(.+?)<\/span>/g, (d, v) => {
      if (v) {
      ...
      if (S.value === "IMAGE" && typeof e.content == "string" && (g(e.content) ? w.value = {
        ...
        const p = b.value;
        b.value = p.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;nbsp;/g, " ").replace(/&nbsp;/g, " "), b.value = E(b.value), b.value = I(b.value), b.value = l(b.value);
      }
      ...
      var p;
      if (n = [], s = [], i.value = !1, T.value = [], O.value = [], S.value === "HTML" && b.value && typeof b.value == "string") {
        const d = ((p = b.value.match(/src="([^"]+)"/g)) == null ? void 0 : p.map((v) => v.slice(5, -1))) || [];
        O.value = d, T.value = U(b.value, 1);
      }
    }, W = (p) => {
      ...
      if (p && p.target instanceof HTMLElement && p.target.tagName === "IMG") {
        ...
        v && v.addEventListener("keydown", Y);
      }
    }, C = (p) => p.map((d) => [d.title ? k("p", {
      id: d.id,
      innerHTML: d.title
    }, null) : null, d.children && d.children.length > 0 ? C(d.children) : k("p", {
      innerHTML: d,
      onClick: Z
    }, null)]), R = (p) => {
      const d = />(.*?)</g;
      ...
      innerHTML: d.title,
      onClick: () => W(d.id)
    }, null) : null, d.children && d.children.length > 0 ? P(d.children) : null])), z = () => {
      t.value = !1;
    }, M = async (p) => {
  ...
  render() {
    const e = () => this.rawItemType === "IMAGE" ? k(V("i-biz-icon"), {
      class: [this.ns.e("image")],
      icon: this.rawItemContent
    }, null) : this.rawItemType === "TEXT" || this.rawItemType === "RAW" ? k("span", {
      class: this.ns.e("text")
    }, [this.rawItemText]) : this.rawItemType === "HEADING1" ? k("h1", {
      class: this.ns.e("h1")
    }, [this.rawItemText]) : this.rawItemType === "HEADING2" ? k("h2", {
      class: this.ns.e("h2")
    }, [this.rawItemText]) : this.rawItemType === "HEADING3" ? k("h3", {
      class: this.ns.e("h3")
    }, [this.rawItemText]) : this.rawItemType === "HEADING4" ? k("h4", {
      class: this.ns.e("h4")
    }, [this.rawItemText]) : this.rawItemType === "HEADING5" ? k("h5", {
      class: this.ns.e("h5")
    }, [this.rawItemText]) : this.rawItemType === "HEADING6" ? k("h6", {
      class: this.ns.e("h6")
    }, [this.rawItemText]) : this.rawItemType === "PARAGRAPH" ? k("p", {
      class: this.ns.e("paragraph")
    }, [this.rawItemText]) : this.rawItemType === "HTML" ? k("div", {
      class: this.ns.e("paragraph")
    }, [k("div", {
      class: this.ns.em("paragraph", "html-content")
    }, [this.renderHTMLContent(this.htmlContent)])]) : this.rawItemType === "VIDEO" ? k("div", {
      ...
      src: this.playerParams.path,
      type: "video/webm"
    }, null), ibiz.i18n.t("component.rawItem.noSupportVideo")])]) : this.rawItemType === "DIVIDER" ? k(V("el-divider"), {
      "content-position": this.dividerParams.contentPosition
    }, {
      default: () => [k("span", {
        innerHTML: this.dividerParams.html
      }, null)]
    }) : this.rawItemType === "INFO" || this.rawItemType === "WARNING" || this.rawItemType === "ERROR" ? k(V("el-alert"), {
    ...
    }, null) : this.rawItemType === "MARKDOWN" ? k(V("iBizMarkDown"), {
      value: this.content,
      disabled: !0
    ...
    }, [e(), this.showImg ? k(V("el-image-viewer"), {
  ...
  setup(e, {
    ...
    let g = "TEXT", h = "";
    c.contentType && (g = c.contentType), (b = c.editorParams) != null && b.contenttype && (g = (A = c.editorParams) == null ? void 0 : A.contenttype), (T = c.editorParams) != null && T.template && (h = c.editorParams.template.replaceAll("//n", "\n")), (_ = c.editorParams) != null && _.TEMPLATE && (h = c.editorParams.TEMPLATE.replaceAll("//n", "\n")), (O = c.editorParams) != null && O.TITLE && (w.value = e.data[c.editorParams.TITLE]), (x = c.editorParams) != null && x.PARSESCRIPT && (o.value = c.editorParams.PARSESCRIPT);
    const m = be(() => !!(e.controlParams && e.controlParams.editmode === "hover"));
    return ie(() => e.value, async (t, n) => {
      if (t !== n && ((typeof t == "string" || typeof t == "number") && (S.value = t), h && t)) {
        ...
        S.value = await ibiz.util.hbs.render(h, s || t);
      }
    }, {
      immediate: !0
    }), {
...
const Oe = {
  install(e) {
    e.component(te.name, te), e.component(re.name, re), fe("RAW_MOB_ANCHO_HTML", () => new ve());
  }
};
export {
  Oe as default
