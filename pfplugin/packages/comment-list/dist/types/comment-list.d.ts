...
export declare const CommentList: import("vue").DefineComponent<{
    value: {
        type: {
    ...
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<CommentListComtroller>, undefined, undefined>;
