...
const q = /* @__PURE__ */ Q({
  ...
  setup(r, {
    ...
    const ae = async (t) => {
      ...
      const l = String(a).substring(0, 6);
      let n = parseInt(l.substring(0, 2), 16), m = parseInt(l.substring(2, 4), 16), C = parseInt(l.substring(4, 6), 16);
      n < 0 && (n = 10), m < 0 && (m = 10), C < 0 && (C = 10);
      const x = "#".concat(n.toString(16).padStart(2, "0")).concat(m.toString(16).padStart(2, "0")).concat(C.toString(16).padStart(2, "0"));
