import { g as Se, c as he } from "./index-d8e05b6d.js";
function Ee(ge, me) {
  for (var n = 0; n < me.length; n++) {
    const b = me[n];
    if (typeof b != "string" && !Array.isArray(b)) {
      for (const E in b)
        if (E !== "default" && !(E in ge)) {
          const i = Object.getOwnPropertyDescriptor(b, E);
          i && Object.defineProperty(ge, E, i.get ? i : {
            enumerable: !0,
            get: () => b[E]
          });
        }
...
function be(ge) {
  throw new Error('Could not dynamically require "' + ge + '". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.');
}
var ve = { exports: {} };
(function(ge, me) {
  (function(n) {
      ...
      (function(i) {
        (function() {
          ...
          function W(l, t, o, T, D) {
            ...
            function fe(_e, de) {
              return te === 1 ? _e[de] : _e.readUInt16BE(de * te);
            }
            var le;
            if (D) {
              var ce = -1;
      ...
      (function(i, a) {
        (function() {
          ...
          z.prototype._read = function(w) {
            ...
            var o = (!v || v.end !== !1) && w !== i.stdout && w !== i.stderr, T = o ? te : _e;
            t.endEmitted ? i.nextTick(T) : l.once("end", T), w.on("unpipe", D);
            function D(de, ye) {
              p("onunpipe"), de === l && ye && ye.hasUnpiped === !1 && (ye.hasUnpiped = !0, fe());
            }
            function te() {
              p("onend"), w.end();
            }
            ...
            var se = !1;
            function fe() {
              p("cleanup"), w.removeListener("close", ue), w.removeListener("finish", pe), w.removeListener("drain", ne), w.removeListener("error", ce), w.removeListener("unpipe", D), l.removeListener("end", te), l.removeListener("end", _e), l.removeListener("data", le), se = !0, t.awaitDrain && (!w._writableState || w._writableState.needDrain) && ne();
            }
            l.on("data", le);
            function le(de) {
              p("ondata");
            ...
            function ce(de) {
              p("onerror", de), _e(), w.removeListener("error", ce), _(w, "error") === 0 && ee(w, de);
            }
            V(w, "error", ce);
            function ue() {
              w.removeListener("finish", pe), _e();
            }
            w.once("close", ue);
            function pe() {
              p("onfinish"), w.removeListener("close", ue), _e();
            }
            w.once("finish", pe);
            function _e() {
              p("unpipe"), l.unpipe(w);
...
var we = ve.exports;
const xe = /* @__PURE__ */ Se(we), Re = /* @__PURE__ */ Ee({
  __proto__: null,
  default: xe
}, [we]);
export {
