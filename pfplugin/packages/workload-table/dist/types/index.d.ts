import { App } from 'vue';
export declare const IBizWorkloadTableControl: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    modelData: {
    ...
    c: import("./workload-table.controller").WorkloadTableController;
