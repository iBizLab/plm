import { App } from 'vue';
export declare const IBizCheckboxListExtend: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    value: (StringConstructor | NumberConstructor)[];
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<import("./controller").CheckboxListExtendController>, undefined, undefined>;
    ...
    c: import("./controller").CheckboxListExtendController;
    ...
    selectArray: import("vue").Ref<(string | number)[]>;
    treeProps: {
        label: string;
        children: string;
    };
    defaultCheckedKeys: import("vue").Ref<(string | number)[]>;
    onSelectArrayChange: (data: IData, arg: IData) => void;
    handleCheckAllChange: (selected: boolean, curItems: IData[], item: IData) => void;
    handleCheckChange: (selectArray: string[], items: IData[], item: IData) => void;
    renderCheckItem: (item: IData) => JSX.Element;
    renderCollapseItem: (Items: IData[], item: IData) => JSX.Element;
    renderDropdownMenu: (Items: IData[], item: IData) => JSX.Element;
