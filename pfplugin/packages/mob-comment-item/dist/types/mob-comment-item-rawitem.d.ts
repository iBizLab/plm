...
export declare const MobCommentItemRawItem: import("vue").DefineComponent<{
    value: (ArrayConstructor | StringConstructor | NumberConstructor)[];
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<MobCommentItemRawItemController>, undefined, undefined>;
    ...
    c: MobCommentItemRawItemController;
    rawRef: Ref<any>;
    previewRef: Ref<any>;
