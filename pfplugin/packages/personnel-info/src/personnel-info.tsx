...
export const PersonnelInfo = defineComponent({
  name: 'IBizPersonnelInfo',
  props: getSpanProps<PersonnelInfoEditorController>(),
  setup(props, { emit }) {
    const ns = useNamespace('personnel-info');
    ...
    const renderContent = (): JSX.Element | string => {
      ...
      return (
        <div class={ns.b('content')}>
          ...
          >
            {renderTextPhoto(showText.value)}
          </div>
