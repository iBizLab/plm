import { ControlVO, GridController, GridRowState, GridUAColumnController, IControlProvider, IMDControlController } from '@ibiz-template/runtime';
...
export declare const onStopPropagation: (e: MouseEvent) => void;
export declare const onActionClick: (detail: IUIActionGroupDetail, event: MouseEvent, controller: GridUAColumnController, row: GridRowState) => Promise<void>;
