...
import { IColumnState, IControlProvider } from '@ibiz-template/runtime';
import { AttachGridController } from './attachment-grid.controller';
export declare function renderColumn(c: AttachGridController, model: IDEGridColumn, renderColumns: IDEGridColumn[], index: number): VNode | null;
export declare function renderChildColumn(c: AttachGridController, model: IDEGridColumn, renderColumns: IDEGridColumn[], index: number): VNode | null;
export declare const AttachmentGridControl: import("vue").DefineComponent<{
    modelData: {
