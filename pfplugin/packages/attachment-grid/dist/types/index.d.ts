import { App } from 'vue';
export declare const IBizAttachmentGridControl: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    modelData: {
    ...
    c: import("./attachment-grid.controller").AttachGridController;
