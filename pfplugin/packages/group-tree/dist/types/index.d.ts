export declare const IBizGroupTreeControl: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    modelData: {
    ...
    c: import("./group-tree.controller").GroupTreeController<import("@ibiz/model-core").IDETree, import("@ibiz-template/runtime").ITreeState, import("./group-tree.event").GroupTreeEvent>;
    ...
    renderContextMenu: (nodeModel: import("@ibiz/model-core").IDETreeNode, nodeData: import("@ibiz-template/runtime").ITreeNodeData) => JSX.Element | null | undefined;
    renderCounter: (nodeModel: import("@ibiz/model-core").IDETreeNode) => JSX.Element | null | undefined;
