...
import { IControlProvider, ITreeNodeData } from '@ibiz-template/runtime';
...
export declare const GroupTreeControl: import("vue").DefineComponent<{
    modelData: {
    ...
    c: GroupTreeController<IDETree, import("@ibiz-template/runtime").ITreeState, import("./group-tree.event").GroupTreeEvent>;
